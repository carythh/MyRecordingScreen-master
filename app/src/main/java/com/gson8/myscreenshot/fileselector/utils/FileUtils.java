...
import com.gson8.myscreenshot.fileselector.config.Picture;
...
public class FileUtils {
    ...
    public static  ArrayList<HashMap<String, Object>>  getFileListVideo(String path){
...
//            listPictures.add(picture);
            ...
            String p = files[i].getAbsolutePath();         //每个文件的路径
            String name = getFileName(p);           //每个文件的名字
            Log.d(TAG, "getFileListVideo: "+name);
